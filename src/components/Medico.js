...
function Medico() {
  ...
  const handleFetch1 = async () => {
    ...
    const query = 'users';
    const language = 'en';
    const cliente_id = 'UAyZcwpLMS7aeLdK1opXUn-5Jams-2O_j420soTVBIs';
    const API_URL = `https://api.unsplash.com/photos/random?client_id=${cliente_id}&query=${query}&lang=${language}`;
